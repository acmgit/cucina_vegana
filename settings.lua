...
-- Asparagus
cucina_vegana.plant_settings.asparagus = minetest.settings:get_bool(cv_setting .. "asparagus") or true
...
-- Chives
cucina_vegana.plant_settings.chives = minetest.settings:get_bool(cv_setting .."chives") or true
...
-- Flax
cucina_vegana.plant_settings.flax = minetest.settings:get_bool(cv_setting .."flax") or true
...
-- Kohlrabi
cucina_vegana.plant_settings.kohlrabi = minetest.settings:get_bool(cv_setting .."kohlrabi") or true
...
-- Lettuce
cucina_vegana.plant_settings.lettuce = minetest.settings:get_bool(cv_setting .."lettuce") or true
...
-- Parsley
cucina_vegana.plant_settings.parsley = minetest.settings:get_bool(cv_setting .."parsley") or true
...
-- Peanut
cucina_vegana.plant_settings.peanut = minetest.settings:get_bool(cv_setting .."peanut") or true
...
-- Rice
cucina_vegana.plant_settings.rice = minetest.settings:get_bool(cv_setting .."rice") or true
...
-- Rosemary
cucina_vegana.plant_settings.rosemary = minetest.settings:get_bool(cv_setting .."rosemary") or true
...
-- Soy
cucina_vegana.plant_settings.soy = minetest.settings:get_bool(cv_setting .."soy") or true
...
-- Sunflowers
cucina_vegana.plant_settings.sunflower = minetest.settings:get_bool(cv_setting .."sunflower") or true
