...
minetest.register_node("cucina_vegana:wild_rice", {
	...
	drop = { 
			items = { 
                    {items = {"cucina_vegana:seed_rice 2"}, rarity = 1},
					{items = {"cucina_vegana:seed_rice 2"}, rarity = 2},
					{items = {"cucina_vegana:rice 2"}, rarity = 1},
                    {items = {"cucina_vegana:rice 2"}, rarity = 2},
                    },
			},
	drawtype = "plantlike",
	paramtype2 = "facedir",
